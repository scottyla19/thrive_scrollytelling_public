...
# had to add some other output to make the map display. Otherwise, the map had 0 width in the rendered output html
...
Meaning that, according to both the 5 Essentials Survey and GreatSchools ratings, we can see that schools that are well organized on the five essentials are in fact set up to improve their outcomes. @cr-ratings_net_score
